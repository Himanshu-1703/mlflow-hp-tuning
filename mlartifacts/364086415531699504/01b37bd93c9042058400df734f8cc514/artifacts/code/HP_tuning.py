...
# parameters grid
params = {
    "clf__n_estimators": list(range(25,125,25)),
    "clf__max_depth": list(range(5,16,1)),
...
with mlflow.start_run(run_name='best model') as parent:
    ...
    for ind in range(len(results['mean_test_accuracy'])):
        ...
        test_metrics = {
            ...
            "test_precision": results["mean_test_precision"][ind],
            "test_f1": results["mean_test_f1"][ind],
            "rank_f1": results["rank_test_f1"][ind]
        }
        ...
        train_metrics = {
            ...
            "train_precision": results["mean_train_precision"][ind],
            "train_f1": results["mean_train_f1"][ind],
        }
        
        # set the child run name
        child_run_name = f'HP Rank {results["rank_test_f1"][ind]}'
        
        with mlflow.start_run(nested=True,run_name=child_run_name) as child:
